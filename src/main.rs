...
fn make_app<'a, 'b>() -> App<'a, 'b> {
    App::new("gatekeeper")
        ...
        .subcommand(SubCommand::with_name("logs")
            .about("Get the globalGatekeeper logs")
        ...
        .subcommand(SubCommand::with_name("sudo")
            .about("Handles the PAM sudo calls by pam_exec forGatekeeper"))
        .subcommand(SubCommand::with_name("su")
            .about("Handles the PAM su calls by pam_exec forGatekeeper"))
        .subcommand(SubCommand::with_name("ssh")
            .about("Handles the PAM SSH calls by pam_exec forGatekeeper"))
        ...
        .subcommand(SubCommand::with_name("config")
            .about("Get or setGatekeeper configuration")
